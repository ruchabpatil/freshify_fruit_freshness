...
Freshify is an educational and experimental AI application developed for academic purposes. The predictions are generated by a machine learning model and may contain errors.

**The application should not be used as the sole basis for determining whether food is safe to consume.**
